                                        ...
                                        >
                                            <div className="px-4 pb-4 space-y-4 border-t border-slate-100 dark:border-slate-800 pt-4">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        isActive
                                                                            ...
                                                                            : "border-slate-200 bg-slate-50 text-slate-500 hover:bg-slate-100 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-slate-400 dark:hover:bg-white/[0.05]"
                                                                    )}
                                                                >
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        isActive
                                                                            ...
                                                                            : "border-slate-200 bg-slate-50 text-slate-500 dark:border-white/[0.06] dark:bg-white/[0.02] dark:text-slate-400"
                                                                    )}
                                                                >
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {isTimeCaptured && (
                                                        <button
                                                            ...
                                                            className="w-8 h-8 rounded-lg border border-slate-200 bg-slate-50 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 dark:border-white/[0.08] dark:bg-white/[0.03] dark:hover:text-red-400 dark:hover:bg-red-500/10 transition-colors"
                                                        >
                                                ...
                                                <Textarea
                                                    ...
                                                    className="min-h-[80px] bg-slate-50 border-slate-200 dark:bg-white/[0.03] dark:border-white/[0.06] resize-none text-sm rounded-xl"
                                                    onKeyDown={(e) => {
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Button
                                                        className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white shadow-lg shadow-indigo-600/20 border-0 h-10 font-bold text-sm rounded-xl"
