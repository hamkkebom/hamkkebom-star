...
const FinancialTrendChart = dynamic(
    () => import("@/components/charts/financial-chart").then((m) => ({ default: m.FinancialTrendChart })),
            ...
            <CardContent className="h-[350px] p-4 pt-0 relative">
                <AnimatePresence mode="wait">
                    {isLoading ? (
                        ...
                        >
                            <FinancialTrendChart data={data || []} amber={amber} rose={rose} textColor={textColor} gridColor={gridColor} />
                        </motion.div>
                    )}
                </AnimatePresence>
            </CardContent>
